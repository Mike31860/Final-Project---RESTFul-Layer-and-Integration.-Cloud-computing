...
public class TsscGame implements Serializable {
	...
	@NotBlank(message = "Debe de ingresar una contraseña",  groups=GameValidar.class)
	...
	@Min(value = 1, message = "Recuerde que los grupos deben ser mayores a 0",   groups=GameValidar.class)
	@Column(name = "N_GROUPS")
	private Integer nGroups = 4;

	@Min(value = 1, message = "Recuerde que los Sprints deben ser mayores a 0",  groups=GameValidar.class)
	@Column(name = "N_SPRINTS")
	private Integer nSprints = 4;

	@NotBlank(message = "Debe de ingresar un nombre",  groups=GameValidar.class)
	private String name;
	...
	@NotBlank(message = "debes de ingrar una contraseña",  groups=GameValidar.class)

...
public class TsscStory implements Serializable {
	...
	@NotNull(message = "Debes e ingresas un valor para el BusinessValue",  groups=StoryValidar.class)
	@Min(value = 1, message ="El BussinessValue debe ser mayor que cero",  groups=StoryValidar.class)
	@Column(name = "BUSINESS_VALUE")
	private BigDecimal businessValue;

	@NotBlank(message = "Debes de ingresas una descripción",  groups=StoryValidar.class)
	private String description;

	@Min(value = 1, message ="El valor del InitialSprint debe ser mayor que cero",  groups=StoryValidar.class)
	@NotNull(message = "Debes de ingresar un valor para el Sprint Inicial",  groups=StoryValidar.class)
	...
	@Min(value = 1, message ="El valor de la prioridad debe ser mayor que cero",  groups=StoryValidar.class)
	@NotNull(message = "Debes de ingresar un valor de prioridad",  groups=StoryValidar.class)
	...
	@NotNull(message = "Asegurate de que existan juegos primero",  groups=StoryValidar.class)
	@ManyToOne
